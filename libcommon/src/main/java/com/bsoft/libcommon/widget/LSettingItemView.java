...
/**
 * 作者：  https://github.com/leonHua/LSettingView
 * 时间：2016/12/21 10:32
 */
public class LSettingItemView extends RelativeLayout {
    /*左侧显示文本*/
    ...
    public LSettingItemView(Context context) {
        this(context, null);
    }

    public LSettingItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LSettingItemView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        mView = View.inflate(context, R.layout.common_layout_setting_item, this);
