package com.bsoft.libcommon.widget.spinneredit;
...
public class DropEditText extends FrameLayout implements View.OnClickListener, OnItemClickListener {
	...
	public DropEditText(Context context, AttributeSet attrs, int defStyle) {
		...
		LayoutInflater.from(context).inflate(R.layout.common_view_drop_edit, this);
		mPopView = (WrapListView) LayoutInflater.from(context).inflate(R.layout.common_view_drop_edit_pop, null);
	...
	public void performDropClick(){
		mDropImage.performClick();
	}
