package com.bsoft.libmain.activity;
...
import com.bsoft.libmain.databinding.ActivityLayoutProfileBinding;
import com.bsoft.libmain.fragment.HomeFragment;
     ...
     //   mBinding.setUser(user);
        ...
        viewPager.setAdapter(new FragmentStateAdapter(this) {
            ...
            public Fragment createFragment(int position) {
                return HomeFragment.newInstance(getTabTypeByPosition(position));
            }
