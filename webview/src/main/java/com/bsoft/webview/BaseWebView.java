...
import com.bsoft.webview.javascriptinterface.WebviewJavascriptInterface;
import com.bsoft.webview.settings.WebviewDefaultSetting;
import com.bsoft.webview.webviewclient.BaseWebviewClient;
...
public class BaseWebView extends WebView implements BaseWebviewClient.WebviewTouch {
    ...
    protected void init(Context context) {
        ...
        mBaseWebviewClient = new BaseWebviewClient(this, webViewCallBack, mHeaders, this);
            ...
            remoteInterface.setJavascriptCommand(new WebviewJavascriptInterface.JavascriptCommand() {
                ...
                public void exec(Context context, String cmd, String params) {
                    if (webViewCallBack != null) {
                        webViewCallBack.exec(context, cmd, params, BaseWebView.this);
                    }
                }
            });
        }
